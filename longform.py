...
1. Hook tweet — a sharp question, bold statement, or surprising fact.
...
5. Balanced insight — explicitly cover both the upside case and the key risk; never take a side.
...
non-partisan.
7. Close with a "What to watch next:" tweet naming specific upcoming dates, data releases, or \
