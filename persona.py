...
VISUAL_GUIDELINES = (
    ...
    "visual_type to exactly one of \"price_chart\", \"bar_chart\", \"histogram\", \"pie_chart\", "
    "\"trend_chart\", \"flowchart\", or \"none\". Only populate the matching data field; leave all "
    "others null. Do not force a visual onto a story that doesn't need one — \"none\" is correct "
    "more often than not.\n\n"
